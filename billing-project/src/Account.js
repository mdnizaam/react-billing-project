                        ...
                        Company logo Starts from here */}
                                ...
                                <div className="col-lg-10" style={{ display: `${sidemenu1}` }}>
                                    ...
                                    <div className=" my-5  textmenu ">
                                        <ul>
                                        <NavLink exact to="/dashboardcsvcontacts" activeStyle={{color:"red"}}><li><span >Dashboard</span></li></NavLink><br></br>
                                        <NavLink exact to="/account" activeStyle={{color:"red"}}><li><span >Account</span></li></NavLink><br></br>

                                        
                                      <NavLink exact to="/reportsettingcopy" activeStyle={{color:"red"}}><li><span >Report Setting</span></li></NavLink> <br></br>
                                       <NavLink  exact to="/inbox" activeStyle={{color:"red"}}><li><span >Inbox</span></li></NavLink> <br></br>
                    ...
                    <div className={`col-lg-${state12}`} style={{ backgroundColor: "#E5E7EB"}}>
                        ...
                        <div className=" float-end mx-5">
                            <ul className="menu-bar my-5 mx-5">
                                {/* <li><NavLink to="/home1"  activeStyle={{color:"red"}}>
                                    HOME
                                </NavLink>
                                </li> */}
                                <li>HOME</li>
                        ...
                        <h1 className="bill">Account</h1>
                        <div className="row">
                            <div className="col-lg-8 ">
                                <button type="button" class="btn btn-danger float-end ms-5"><DeleteOutlineOutlinedIcon></DeleteOutlineOutlinedIcon> Delete Account</button>
                            </div>
                                                ...
                                                <div className="col-lg-8">
                                                    <form action="/action_page.php" class="was-validated">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="ename" placeholder="Enter Email" name="ename" required />
                                                            <div class="valid-feedback">Valid.</div>
                                                            <div class="invalid-feedback">Please fill out this field.</div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" id="pwd" placeholder="Current password" name="pswd" required />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" id="pwd" placeholder="Min 8 Character" name="pswd" required />
                                                            <div class="valid-feedback">Valid.</div>
                                                            <div class="invalid-feedback">Please fill out this field.</div>
                                                        </div>
                        ...
                        <div className="container-fluid ">
                            <div className="row">
                                ...
                                {/* <div className="col-lg-8  my-5  ">
                                    ...
                                    <div className="col-sm-3 col-lg-3 f-menu my-5">
                                    ...
                                    <div className="col-sm-3  col-md-3 col-lg-3 f-menu my-5">
