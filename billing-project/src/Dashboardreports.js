                        ...
                        Company logo Starts from here */}
                                ...
                                <div className="col-lg-10" style={{ display: `${sidemenu1}` }}>
                                    ...
                                    <div className=" my-5  textmenu ">
                                      ...
                                      <NavLink to="/reportsettingcopy"  activeStyle={{color:"black"}}><li><span >Report Setting</span></li></NavLink> <br></br>
                                ...
                                <div className="container-fluid">
                                    <div className="row">
                                        <div className="col-lg-2 float-end mx-5">
                                            ...
                                            <NavLink to="/dashboardcsvcontacts" activeStyle={{ color: "red" }}><p className="display-5" style={{fontSize:"20px"}}>Service csv</p></NavLink>
                                        </div>
                                                ...
                                                <div className="col-lg-8">
                                                    ...
                                                    <div className="container">
                                                        <div className="row ">
                                                            ...
                                                            <div className="col">
                                                            <div className="float-end mx-5"><button className="btn btn-success ">Download All-zip <GetAppRoundedIcon></GetAppRoundedIcon></button></div>
                                                                {/* <button className="btn btn-success ">Download All-zip <GetAppRoundedIcon></GetAppRoundedIcon></button> */}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
