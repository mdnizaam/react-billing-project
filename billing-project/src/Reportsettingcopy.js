...
function Reportsettingcopy() {
    ...
    return (
        ...
        <div>
            ...
            <div className="container-fluid">
                <div className="row">
                        ...
                        Company logo Starts from here */}
                                ...
                                <div className="col-lg-10" style={{ display: `${sidemenu1}` }}>
                                    ...
                                    <div className=" my-5  textmenu ">
                                        <ul>
                                        <NavLink to="/dashboardcsvcontacts"  activeStyle={{color:"bred"}}><li><span >Dashboard</span></li></NavLink><br></br>
                                        <NavLink to="/account"  activeStyle={{color:"bred"}}><li><span >Account</span></li></NavLink><br></br>

                                        
                                      <NavLink to="/reportsettingcopy"  activeStyle={{color:"bred"}}><li><span >Report Setting</span></li></NavLink> <br></br>
                                       <NavLink to="/inbox"  activeStyle={{color:"bred"}}><li><span >Inbox</span></li></NavLink> <br></br>
                                       <NavLink exact to="/"  activeStyle={{color:"bred"}}><li><span >Billing</span></li></NavLink>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div className={`col-lg-${state12}`} style={{ backgroundColor: "#E5E7EB"}}>
                        ...
                        <h1 className="bill">Report Setting</h1>
                        <div className="row">
                                                ...
                                                <div className="col-lg-8">
                                                    <form action="/action_page.php" class="was-validated">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="uname">Report Email Address:</label>
                                                        ...
                                                        {/* radio buttons starts from here */}
                                                        <div className="container-fluid my-5" style={{ background: "white" }}>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="usr">Report Time To Send (24hr)</label>
            ...
            export default Reportsettingcopy;
